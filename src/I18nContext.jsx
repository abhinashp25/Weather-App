...
const translations = {
  en: {
    ...
    aiSubtitle: 'Context-aware recommendations based on weather, visibility, wind, humidity, and AQI.',
    // AI Tips
    ...
    tipThunderstorm: 'Thunderstorm risk is high — avoid open areas and delay non-essential travel',
    tipSnowRoad: 'Snow expected — use low speed and keep extra braking distance',
    tipHighHumidity: 'High humidity can feel uncomfortable — wear breathable clothes and drink water',
    tipDryAirHydrate: 'Air is very dry — stay hydrated and protect your skin',
    tipGeneralBalanced: 'Weather is fairly balanced right now — normal activity is fine',
    // Time Travel
  ...
  hi: {
    ...
    aiSubtitle: 'मौसम, दृश्यता, हवा, आर्द्रता और AQI के आधार पर सुझाव।',
    ...
    tipThunderstorm: 'तूफान का खतरा अधिक है — खुले क्षेत्रों से बचें',
    tipSnowRoad: 'बर्फबारी में धीरे चलाएं और ब्रेक दूरी बढ़ाएं',
    tipHighHumidity: 'अधिक नमी असुविधाजनक हो सकती है — हल्के कपड़े पहनें और पानी पिएं',
    tipDryAirHydrate: 'हवा बहुत शुष्क है — हाइड्रेटेड रहें',
    tipGeneralBalanced: 'मौसम संतुलित है — सामान्य गतिविधि ठीक है',
    ...
    mapLayerLabel: 'मैप लेयर्स',
    mapLayerRadar: 'रडार',
    mapLayerSatellite: 'सैटेलाइट',
    mapLayerWind: 'हवा',
    mapLayerTemp: 'तापमान',
    mapLayerClouds: 'बादल',
    mapZoomIn: 'ज़ूम इन',
    mapZoomOut: 'ज़ूम आउट',
    mapOpenFull: 'पूरा मैप खोलें',
  ...
  od: {
    ...
    aiSubtitle: 'ପାଣିପାଗ, ଦୃଶ୍ୟତା, ବାୟୁ, ଆର୍ଦ୍ରତା ଏବଂ AQI ଆଧାରିତ ପରାମର୍ଶ।',
    ...
    tipThunderstorm: 'ବଜ୍ରପାତ ଝୁମ୍କି ଅଧିକ — ଖୋଲା ସ୍ଥାନରୁ ଦୂରେ ରୁହନ୍ତୁ',
    tipSnowRoad: 'ହିମ ପରିସ୍ଥିତିରେ ଧୀରେ ଚଲାନ୍ତୁ ଏବଂ ବ୍ରେକ ଦୂରତା ରଖନ୍ତୁ',
    tipHighHumidity: 'ଅଧିକ ଆର୍ଦ୍ରତାରେ ଅସୁବିଧା ହୋଇପାରେ — ହାଲୁକା ପୋଷାକ ପିନ୍ଧନ୍ତୁ ଏବଂ ପାଣି ପିଉନ୍ତୁ',
    tipDryAirHydrate: 'ବାୟୁ ଅଧିକ ଶୁଷ୍କ — ହାଇଡ୍ରେଟେଡ୍ ରୁହନ୍ତୁ',
    tipGeneralBalanced: 'ବର୍ତ୍ତମାନ ପାଣିପାଗ ସମତୁଳିତ — ସାଧାରଣ କାର୍ଯ୍ୟକଳାପ ଠିକ୍ ଅଛି',
    ...
    mapLayerLabel: 'ମ୍ୟାପ୍ ଲେୟର',
    mapLayerRadar: 'ରଡାର',
    mapLayerSatellite: 'ସ୍ୟାଟେଲାଇଟ୍',
    mapLayerWind: 'ବାୟୁ',
    mapLayerTemp: 'ତାପମାତ୍ରା',
    mapLayerClouds: 'ମେଘ',
    mapZoomIn: 'ଜୁମ୍ ଇନ୍',
    mapZoomOut: 'ଜୁମ୍ ଆଉଟ୍',
    mapOpenFull: 'ପୂର୍ଣ୍ଣ ମ୍ୟାପ୍ ଖୋଲନ୍ତୁ',
